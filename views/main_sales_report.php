                        ...
                        <div class="content">
                            ...
                            <div class="module">
                                <div class="module-head">
                                    <h3>
                                       MAIN BRANCH SALES REPORT <td><?php
	echo'<a href="ink@best_print/sales_report_view_main.php?from='.$from.'&to='.$to.'" target="_blank" class="btn btn-success">'?>Print</a></td></h3>
                                </div>
