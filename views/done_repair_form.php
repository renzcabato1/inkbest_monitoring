                            ...
                            <div class="module">
                                <div class="module-head">
									...
									<form method='post' class="form-horizontal row-fluid">
										...
										<div class="control-group">
											<label class="control-label" for="basicinput">Problem Found</label>
											<div class="controls">
												<input type="text" name='problem_found'  id="basicinput" placeholder="" class="span8" required>
											</div>
										</div>
										<div class="control-group">
											<label class="control-label" for="basicinput">Remarks</label>
											<div class="controls">
												<input type="text" name='remarks'  id="basicinput" placeholder="" class="span8" required>
											</div>
										</div>
